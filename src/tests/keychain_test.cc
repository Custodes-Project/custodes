...
TEST(KeychainTest, Integration) {
    keychain::Error error;

    const std::string package = "com.test.keychain-test";
    const std::string service = "test";
    const std::string user = "gtest";

    keychain::setPassword(package, service, user, "testpass", error);
    if (error) {
